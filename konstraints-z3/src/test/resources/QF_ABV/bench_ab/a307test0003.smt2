...
(assert (not (not (= (select buf (concat (_ bv0 24) (select s (_ bv1 32)))) (_ bv0 8)))))
(assert (not (not (= (select buf (concat (_ bv0 24) (select s (_ bv2 32)))) (_ bv0 8)))))
(assert (not (not (= (select buf (concat (_ bv0 24) (select s (_ bv3 32)))) (_ bv0 8)))))
(check-sat)
(exit)
