/**
 * Definition of SMTLib Core theory according to
...
/**
 * Implements not according to Core theory
 * (not Bool Bool)
...
/**
 * Implements implication according to Core theory
...
/**
 * Implements and according to Core theory
...
/**
 * Implements or according to Core theory
...
/**
 * Implements xor according to Core theory
...
/**
 * Implements equals according to Core theory
...
class Equals(val statements : List<Expression<BoolSort>>) : Expression<BoolSort>() {
    ...
    /**
     * The symbol uses the :chainable short form
...
/**
 * Implements distinct according to Core theory
...
class Distinct(val statements : List<Expression<BoolSort>>) : Expression<BoolSort>() {
    ...
    /**
     * The symbol uses the :pairwise short form
     * (distinct A B C) is short for (and (distinct A B) (distinct A C) (distinct B C))
     */
...
/**
 * Implements ite according to Core theory
 ...
 */
class Ite(val statement : Expression<BoolSort>,
          val then : Expression<BoolSort>,
          val els : Expression<BoolSort>) : Expression<BoolSort>() {
    override val sort : BoolSort = BoolSort
