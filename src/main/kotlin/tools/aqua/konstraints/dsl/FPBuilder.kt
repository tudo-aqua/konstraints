...
private fun Builder<FPSort>.makeUnaryOperation(roundingMode: Expression<RoundingMode>, block: Builder<FPSort>.() -> Expression<FPSort>, operation: (Expression<RoundingMode>, Expression<FPSort>) -> Expression<FPSort>): Expression<FPSort> {
    this.children.add(operation(roundingMode, Builder<FPSort>().block()))

    return this.children.last()
}

fun Builder<FPSort>.fpsqrt(roundingMode: Expression<RoundingMode> = RNE, block: Builder<FPSort>.() -> Expression<FPSort>) = this.makeUnaryOperation(roundingMode, block, ::FPSqrt)
fun Builder<FPSort>.fproundToIntegral(roundingMode: Expression<RoundingMode> = RNE, block: Builder<FPSort>.() -> Expression<FPSort>) = this.makeUnaryOperation(roundingMode, block, ::FPRoundToIntegral)
...
private fun<T : Sort> Builder<FPSort>.makeConversionOperator(eb: Int, sb: Int, roundingMode: Expression<RoundingMode>, block: Builder<T>.() -> Expression<T>, op: (Expression<RoundingMode>, Expression<T>, Int, Int) -> Expression<FPSort>): Expression<FPSort> {
...
@JvmName("FPToFP")
fun Builder<FPSort>.toFP(eb: Int, sb: Int, roundingMode: Expression<RoundingMode> = RNE, block: Builder<FPSort>.() -> Expression<FPSort>) = this.makeConversionOperator(eb, sb, roundingMode, block, ::FPToFP)
@JvmName("FPToReal")
fun Builder<FPSort>.toFP(eb: Int, sb: Int, roundingMode: Expression<RoundingMode> = RNE, block: Builder<RealSort>.() -> Expression<RealSort>) = this.makeConversionOperator(eb, sb, roundingMode, block, ::RealToFP)
@JvmName("FPToSBV")
fun Builder<FPSort>.toFP(eb: Int, sb: Int, roundingMode: Expression<RoundingMode> = RNE, block: Builder<BVSort>.() -> Expression<BVSort>) = this.makeConversionOperator(eb, sb, roundingMode, block, ::SBitVecToFP)
@JvmName("FPToUBV")
fun Builder<FPSort>.toFPUnsigned(eb: Int, sb: Int, roundingMode: Expression<RoundingMode> = RNE, block: Builder<BVSort>.() -> Expression<BVSort>) = this.makeConversionOperator(eb, sb, roundingMode, block, ::UBitVecToFP)

fun Builder<FPSort>.toFP(eb: Int, sb: Int, block: Builder<BVSort>.() -> Expression<BVSort>, op: (Expression<RoundingMode>, Expression<BVSort>, Int, Int) -> Expression<FPSort>): Expression<FPSort> {
    this.children.add(BitVecToFP(Builder<BVSort>().block(), eb, sb))

    return this.children.last()
}

fun Builder<BVSort>.toUBV(m: Int, roundingMode: Expression<RoundingMode> = RNE, block: Builder<FPSort>.() -> Expression<FPSort>): Expression<BVSort> {
    this.children.add(FPToUBitVec(roundingMode, Builder<FPSort>().block(), m))

    return this.children.last()
}

fun Builder<BVSort>.toSBV(m: Int, roundingMode: Expression<RoundingMode> = RNE, block: Builder<FPSort>.() -> Expression<FPSort>): Expression<BVSort> {
    this.children.add(FPToSBitVec(roundingMode, Builder<FPSort>().block(), m))

    return this.children.last()
}

fun Builder<RealSort>.toReal(block: Builder<FPSort>.() -> Expression<FPSort>): Expression<RealSort> {
...
fun fpfma(roundingMode: Expression<RoundingMode> = RNE, multiplier: Builder<FPSort>.() -> Expression<FPSort>) = FPFMA1(roundingMode, Builder<FPSort>().multiplier())

class FPFMA1(val roundingMode: Expression<RoundingMode>, val multiplier: Expression<FPSort>) {
    infix fun mul(multiplicant: Builder<FPSort>.() -> Expression<FPSort>) = FPFMA2(roundingMode, multiplier, Builder<FPSort>().multiplicant())
}

class FPFMA2(val roundingMode: Expression<RoundingMode>, val multiplier: Expression<FPSort>, val multiplicant: Expression<FPSort>) {
    infix fun add(summand: Builder<FPSort>.() -> Expression<FPSort>) = FPFma(roundingMode, multiplier, multiplicant, Builder<FPSort>().summand())
}