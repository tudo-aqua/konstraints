 ...
 * If [this] is an [IntSub] object, unpacks the children and returns a new combined IntSub.
 */
infix fun (() -> Expression<IntSort>).minus(subtrahend: Expression<IntSort>) =
 ...
 * If [this] is an [IntAdd] object, unpacks the children and returns a new combined IntAdd.
 */
infix fun (() -> Expression<IntSort>).plus(summand: () -> Expression<IntSort>) =
    this() plus summand()
 ...
 * If [this] is an [IntMul] object, unpacks the children and returns a new combined IntMul.
 */
infix fun Expression<IntSort>.times(multiplicand: () -> Expression<IntSort>) =
...
/** Greater operator for IntSort Expressions: [this] > [other]. */
infix fun (() -> Expression<IntSort>).greater(other: () -> Expression<IntSort>) =
    this() greater other()
...
/** Greater equals operator for IntSort Expressions: [this] >= [other]. */
infix fun (() -> Expression<IntSort>).greaterEq(other: () -> Expression<IntSort>) =
...
/** Less equals operator for IntSort Expressions: [this] <= [other]. */
infix fun (() -> Expression<IntSort>).lessEq(other: () -> Expression<IntSort>) =
    this() lessEq other()
