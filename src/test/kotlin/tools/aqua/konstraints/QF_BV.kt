...
class QF_BV {
    ...
    private fun solve(file: File) {
        Assumptions.assumeTrue(file.length() < 5000000, "Skipped due to file size exceeding limit of 5000000")
    ...
    fun getQFBV20170501_Heizmann_UltimateAutomizer(): Stream<Arguments> = loadResource("/QF_BV/20170501-Heizmann-UltimateAutomizer/")
    ...
    fun getQFBV20170531_Hansen_Check(): Stream<Arguments> = loadResource("/QF_BV/20170531-Hansen-Check/")
    ...
    fun getQFBV20190311_bv_term_small_rw_Noetzli(): Stream<Arguments> = loadResource("/QF_BV/20190311-bv-term-small-rw-Noetzli/")
    ...
    fun getQFBV20190429_UltimateAutomizerSvcomp2019(): Stream<Arguments> = loadResource("/QF_BV/20190429-UltimateAutomizerSvcomp2019/")
    ...
    fun getQFBV20221214_p4dfa_XiaoqiChen(): Stream<Arguments> = loadResource("/QF_BV/20221214-p4dfa-XiaoqiChen/")
    ...
    fun getQFBV20230221_oisc_gurtner(): Stream<Arguments> = loadResource("/QF_BV/20230221-oisc-gurtner/")
    ...
    fun getQFBV20230224_grsbits_truby(): Stream<Arguments> = loadResource("/QF_BV/20230224-grsbits-truby/")
    ...
    fun getQFBV20230321_UltimateAutomizerSvcomp2023(): Stream<Arguments> = loadResource("/QF_BV/20230321-UltimateAutomizerSvcomp2023/")
    ...
    fun getQFBVuclid_contrib_smtcomp09(): Stream<Arguments> = loadResource("/QF_BV/uclid_contrib_smtcomp09/")
