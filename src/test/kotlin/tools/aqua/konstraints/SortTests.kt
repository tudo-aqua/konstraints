...
class SortTests {
  ...
  private fun getSortsAndTheirSerialization(): Stream<Arguments> {
    return Stream.of(
        ...
        arguments("(_ BitVec 32)", BVSort.BVSort32),
  ...
  private fun getEqualBVSortObjects(): Stream<Arguments> {
    return Stream.of(
        ...
        arguments(BVSort.BVSort32, BVSort.BVSort32),
        arguments(BVSort.BVSort32, BVSort(32)))
  }
  ...
  private fun getUnequalBVSortObjects(): Stream<Arguments> {
    return Stream.of(
        ...
        arguments(BVSort.BVSort32, BVSort(16)),
        arguments(BVSort.BVSort32, BVSort.BVSort16))
  }
  ...
  private fun getBVSortObjects(): Stream<Arguments> {
    return Stream.of(arguments(BVSort.BVSort32), arguments(BVSort.BVSort16), arguments(BVSort(8)))
  }
