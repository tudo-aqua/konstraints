...
(assert (let ((?v_0 (store (store (store (store ft_client_main_3 (_ bv0 32) (select buf (_ bv0 32))) (_ bv1 32) (select buf (_ bv1 32))) (_ bv2 32) (select buf (_ bv2 32))) (_ bv3 32) (select buf (_ bv3 32))))) (= (concat (concat (concat (select ?v_0 (_ bv3 32)) (select ?v_0 (_ bv2 32))) (select ?v_0 (_ bv1 32))) (select ?v_0 (_ bv0 32))) (_ bv305419896 32))))
(check-sat)
(exit)
