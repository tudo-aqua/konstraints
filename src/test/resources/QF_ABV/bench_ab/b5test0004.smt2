...
(assert (bvsle (_ bv48 32) (concat (_ bv0 24) (select (store p (_ bv2 32) (_ bv0 8)) (_ bv1 32)))))
(assert (not (bvsle (concat (_ bv0 24) (select (store p (_ bv2 32) (_ bv0 8)) (_ bv1 32))) (_ bv57 32))))
(check-sat)
(exit)
