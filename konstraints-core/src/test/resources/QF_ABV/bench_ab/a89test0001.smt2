...
(assert (let ((?v_0 (concat (concat (concat (concat ((_ extract 5 0) (select filter (_ bv3 32))) (select filter (_ bv2 32))) (select filter (_ bv1 32))) (select filter (_ bv0 32))) (_ bv0 2)))) (not (and (bvule (_ bv0 32) ?v_0) (bvule ?v_0 (_ bv63 32))))))
(check-sat)
(exit)
