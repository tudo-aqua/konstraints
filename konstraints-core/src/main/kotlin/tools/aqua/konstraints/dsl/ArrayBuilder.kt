...
@JvmName("atIntSortInt") infix fun Expression<IntSort>.at(index: Int) = this to IntLiteral(index)
...
@JvmName("atIntIntSort") infix fun Int.at(index: Expression<IntSort>) = IntLiteral(this) to index
...
@JvmName("atIntInt") infix fun Int.at(index: Int) = IntLiteral(this) to IntLiteral(index)
...
@JvmName("atBoolSortInt") infix fun Expression<BoolSort>.at(index: Int) = this to IntLiteral(index)
...
@JvmName("atBooleanInt") infix fun Boolean.at(index: Int) = this.toSMTBool() to IntLiteral(index)
...
@JvmName("atStringInt") infix fun String.at(index: Int) = StringLiteral(this) to IntLiteral(index)
...
@JvmName("atRealSortInt") infix fun Expression<RealSort>.at(index: Int) = this to IntLiteral(index)
...
@JvmName("atFPSortInt") infix fun Expression<FPSort>.at(index: Int) = this to IntLiteral(index)
...
@JvmName("atBVSortInt") infix fun Expression<BitVecSort>.at(index: Int) = this to IntLiteral(index)
...
@JvmName("atIntBoolSort") infix fun Int.at(index: Expression<BoolSort>) = IntLiteral(this) to index
...
@JvmName("atIntBoolean") infix fun Int.at(index: Boolean) = IntLiteral(this) to index.toSMTBool()
...
@JvmName("atIntString") infix fun Int.at(index: String) = IntLiteral(this) to StringLiteral(index)
...
@JvmName("atIntRealSort") infix fun Int.at(index: Expression<RealSort>) = IntLiteral(this) to index
...
@JvmName("atIntFPSort") infix fun Int.at(index: Expression<FPSort>) = IntLiteral(this) to index
...
@JvmName("atIntBVSort") infix fun Int.at(index: Expression<BitVecSort>) = IntLiteral(this) to index
...
@JvmName("getByteIndexIntArray")
operator fun <Y : Sort> Expression<ArraySort<IntSort, Y>>.get(index: Byte) =
    ArraySelect(this, IntLiteral(index))

@JvmName("getShortIndexIntArray")
operator fun <Y : Sort> Expression<ArraySort<IntSort, Y>>.get(index: Short) =
    ArraySelect(this, IntLiteral(index))

@JvmName("getIntIndexIntArray")
operator fun <Y : Sort> Expression<ArraySort<IntSort, Y>>.get(index: Int) =
    ArraySelect(this, IntLiteral(index))

@JvmName("getLongIndexIntArray")
operator fun <Y : Sort> Expression<ArraySort<IntSort, Y>>.get(index: Long) =
    ArraySelect(this, IntLiteral(index))

@JvmName("getBigIntIndexIntArray")
operator fun <Y : Sort> Expression<ArraySort<IntSort, Y>>.get(index: BigInteger) =
    ArraySelect(this, IntLiteral(index))

@JvmName("getByteIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: Byte) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getShortIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: Short) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getIntIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: Int) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getLongIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: Long) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getBigIntIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: BigInteger) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getFloatIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: Float) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getDoubleIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: Double) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getBigDecimalIndexRealArray")
operator fun <Y : Sort> Expression<ArraySort<RealSort, Y>>.get(index: BigDecimal) =
    ArraySelect(this, RealLiteral(index))

@JvmName("getBoolIndexBoolArray")
operator fun <Y : Sort> Expression<ArraySort<BoolSort, Y>>.get(index: Boolean) =
    ArraySelect(this, index.toSMTBool())

@JvmName("getFloatIndexFloatArray")
operator fun <Y : Sort> Expression<ArraySort<FPSort, Y>>.get(index: Float) =
    ArraySelect(this, FPLiteral(index))

@JvmName("getDoubleIndexFloatArray")
operator fun <Y : Sort> Expression<ArraySort<FPSort, Y>>.get(index: Double) =
    ArraySelect(this, FPLiteral(index))

@JvmName("getByteIndexBitVecArray")
operator fun <Y : Sort> Expression<ArraySort<BitVecSort, Y>>.get(index: Byte) =
    ArraySelect(this, BVLiteral(index))

@JvmName("getShortIndexBitVecArray")
operator fun <Y : Sort> Expression<ArraySort<BitVecSort, Y>>.get(index: Short) =
    ArraySelect(this, BVLiteral(index))

@JvmName("getIntIndexBitVecArray")
operator fun <Y : Sort> Expression<ArraySort<BitVecSort, Y>>.get(index: Int) =
    ArraySelect(this, BVLiteral(index))

@JvmName("getLongIndexBitVecArray")
operator fun <Y : Sort> Expression<ArraySort<BitVecSort, Y>>.get(index: Long) =
    ArraySelect(this, BVLiteral(index))

@JvmName("getBigIntegerIndexBitVecArray")
operator fun <Y : Sort> Expression<ArraySort<BitVecSort, Y>>.get(index: BigInteger) =
    ArraySelect(this, BVLiteral(index))

@JvmName("getStringIndexStringArray")
operator fun <Y : Sort> Expression<ArraySort<StringSort, Y>>.get(index: String) =
