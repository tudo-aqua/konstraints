...
@JvmName("toIntLambdaPrefix") fun toInt(block: () -> Expression<RealSort>) = ToInt(block())

/** Casting operator from RealSort to IntSort. */
@JvmName("toIntPrefix") fun toInt(expr: Expression<RealSort>) = ToInt(expr)

/** Casting operator from RealSort to IntSort. */
@JvmName("toIntLambdaPostfix") fun (() -> Expression<RealSort>).toInt() = ToInt(this())

/** Casting operator from RealSort to IntSort. */
@JvmName("toIntPostfix") fun Expression<RealSort>.toInt() = ToInt(this)
