...
(assert (not (not (= (select (store buf (_ bv32 32) (_ bv1 8)) (concat (_ bv0 24) (select s (_ bv1 32)))) (_ bv0 8)))))
(assert (not (not (= (select (store (store buf (_ bv32 32) (_ bv1 8)) (_ bv32 32) (_ bv1 8)) (concat (_ bv0 24) (select s (_ bv2 32)))) (_ bv0 8)))))
(assert (not (not (= (select (store (store (store buf (_ bv32 32) (_ bv1 8)) (_ bv32 32) (_ bv1 8)) (_ bv32 32) (_ bv1 8)) (concat (_ bv0 24) (select s (_ bv3 32)))) (_ bv0 8)))))
(check-sat)
(exit)
